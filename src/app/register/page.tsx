            ...
            <div className="wrapper  flex flex-col justify-between">
                <div className="flex items-center justify-center gap-16 w-full flex-1">
                    <main className="flex flex-col row-start-2 pt-2 md:pt-[70px] items-start sm:items-start px-6 md:px-20">
                        ...
                        <div className="mt-5  md:my-10 bg-[#9AD6D3] relative z-[99] rounded-3xl md:p-[60px] p-6 w-full">
                            <form
                                ...
                                <div className="mt-4">
                                    ...
                                    >
                                        ...
                                        <p>
                                            <span>
                                                Concordo em receber
                                                atualizações, promoções e
                                                conteúdos exclusivos da BB
                                                Seguros, conforme os{' '}
                                            </span>
                                            <a
                                                className="underline text-[#42489D]"
                                                onClick={() =>
                                                    setShowTerms(true)
                                                }
                                            >
